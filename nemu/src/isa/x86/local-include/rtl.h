...
static inline def_rtl(is_sub_carry, rtlreg_t* dest,
  ...
  {
  case 4:rtl_li(s,dest,interpret_relop(RELOP_LTU,*src1,*src2));break;
  case 2:rtl_li(s,dest,interpret_relop(RELOP_LTU,(uint16_t)*src1,(uint16_t)*src2));break;
  case 1:rtl_li(s,dest,interpret_relop(RELOP_LTU,(uint8_t)*src1, (uint8_t)*src2));break;
  default:
    break;
  }
}
