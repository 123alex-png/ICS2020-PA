...
static inline def_EHelper(2byte_esc) {
  ...
  /* TODO: Add more instructions!!! */
    IDEX (0x00, gp7_E, gp6)
    IDEX (0x01, gp7_E, gp7)
    EX (0x20, naive_movc2r)
    EX (0x22, naive_movr2c)
    IDEX (0x80, J, jcc)
    IDEX (0x81, J, jcc)
    IDEX (0x82, J, jcc)
    IDEX (0x83, J, jcc)
...
again:
  ...
  case 0x66: s->isa.is_operand_size_16 = true; goto again;
    ...
    IDEXW(0x6b, I_E2G, imul3, 1)//problem
    IDEXW(0x70, J, jcc, 1)
    IDEXW(0x71, J, jcc, 1)
    IDEXW(0x72, J, jcc, 1)
    IDEXW(0x73, J, jcc, 1)
