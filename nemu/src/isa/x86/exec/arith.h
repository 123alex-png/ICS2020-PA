...
// static inline def_EHelper(add) {//s2:OF 
...
// static inline def_EHelper(sub) {//s1:减出结果 s2:OF s0:CF
...
//   rtl_li(s,s0,1);
//   rtl_li(s,s1,c_add(*ddest,*s0));
//   rtl_update_ZFSF(s, s1, id_dest->width);
//   rtl_is_add_overflow(s, s2, s1, ddest, s0, id_dest->width);
//   rtl_set_OF(s, s2);
//   operand_write(s, id_dest, s1);
...
//   rtl_li(s,s0,1);
//   rtl_li(s,s1,c_sub(*ddest,*s0));
//   rtl_update_ZFSF(s, s1, id_dest->width);
//   rtl_is_sub_overflow(s, s2, s1, ddest, s0, id_dest->width);
//   rtl_set_OF(s, s2);
//   operand_write(s, id_dest, s1);
...
static inline def_EHelper(neg) {
  *s0=0;
  ...
  rtl_update_ZFSF(s,s1,id_dest->width);
  rtl_is_sub_overflow(s,s2,s1,s0,ddest,id_dest->width);
  rtl_set_OF(s,s2);
  rtl_is_sub_carry(s,s2,s0,ddest);
  rtl_set_CF(s,s2);
  //if(*s1==0x7961)printf("neg\n");
  operand_write(s,id_dest,s1);
  print_asm_template1(neg);
}
